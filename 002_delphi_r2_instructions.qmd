...
You will all have this doc and a revised version of your response excel sheet[^002_delphi_r2_instructions-1] . Open both, you'll be switching between them a fair amount (Alt + tab switches between windows).
...
categorised_vf_fig(filtered_data = filtered_data,
                   ind.num = ind.num,
