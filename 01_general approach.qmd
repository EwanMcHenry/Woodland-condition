...
Weightings describe the importance of indicators to ecological condition, relative to each other. For example, if deadwood was considered twice as important as horizontal complexity, these indicators might have weightings of two and one, respectively.
