...
ind.table$diff <- c(1, 1, 1, 2, 1, 
                    1, 1, 1, 1, 1,
                    1, 3, 2, 3)
names(ind.table) <- c("Indicator", "Description", "Difficulty of measurement")
