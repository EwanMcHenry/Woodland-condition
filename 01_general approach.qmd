...
Value functions can be continuous or categorical (e.g. Low, medium, high), but categories must have relative values assigned to them (e.g. 0, 30, 100).
...
More native canopy needed for "good" condition for that indicator

![](images/toy%20-s%2002.png)

### Scenario 3: changed weights

Valuing age class diversity more than canopy nativeness, and reducing the difference in importance between them.
