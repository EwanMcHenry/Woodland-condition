...
Some further consideration should be given to how to best facilitate useful and robust weightings from the expert panel, either through better explaination of the process and discussion of whether or not variable weightings should be considered, or by using a different exercise to elicit expert opinion such as:
