...
There a lot of variation between respondents for [raw indicator weightings](#sec-raw_weights), much more than there was between actual indicators. This may have be partly because respondents varied a lot in terms of the [amount of difference between indicators](#variation in raw indicators). This limited what useful information could be drawn from raw weightings, and prompted an exploration of the [ranking of indicator weightings](#sec-rank_weights) by respondents and [Standardised weights](#sec-standardised_weights) (transformed so that all respondents varied the same amount between indicators).

Many respondents provided estimates that were very similar between indicators. The implications of this are discussed [below](#variation in raw indicators).
