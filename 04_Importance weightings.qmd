...
The patterns and groupings between respondents could be used to construct workshop breakout groups. For example, groups could be designed to bring together respondents who differed most in their initial responses.
...
## Respondents varied in the amount of difference between indicators

Respondents varied in terms of [the amount of difference]{.underline} between their indicator weights. The figure below shows how much variation there was between the weightings given by each respondent. Respondents with lower standard deviations weighted indicators more similarly, while those with higher tended to vary much more between indicators.
...
-   **Arrow directions** suggest which indicators generally drive dissagrements in different locations on the plot.
...
Participants might want to reflect on those indicators that most separate them from each other, and a general consensus.

> **Worked example** (see standardised weightings tab): Martin (sorry Martin!) might reflect that:
>
> -   He is around an "average" opinion RE invasive plants weighting;
>
>     -   That arrow is clearly a hot topic that divides opinion, but it hasn't dragged him particuarlly far in its direction.
>
> -   He seems to value vertical structure more than most, but maybe he has good reason to! How certain was he again??
>
> -   He weights woodland extent lower than most, but its not a very contentious topic (blue line).
>
> -   He can also see an indication of what indicators he typically agrees with other respondents on.
