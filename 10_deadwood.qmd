...
-   Woodpasture/ parkland
    ...
    -   Potentially more deadwood expected for favourable quality[^10_deadwood-6]. But could also be more important feature (higher weighting).

    -   May need larger/more plots[^10_deadwood-7].

[^10_deadwood-3]: \[\[Chris Reid\]\], \[\[Kylie Jones Mattock\]\],\[\[Hannah Patterson\]\], \[\[Ian Moss\]\]

[^10_deadwood-4]: \[\[Chris Reid\]\]

[^10_deadwood-5]: \[\[Hannah Patterson\]\], \[\[Liam Plummer\]\], \[\[Louise Hackett\]\]

[^10_deadwood-6]: \[Chris Reid\]

[^10_deadwood-7]: \[Liam Plummer\]

Cause is important context, e.g. If from disease [^10_deadwood-8] or large-scale windblow event[^10_deadwood-9]
...
[^10_deadwood-15]: \[\[Peter Lowe\]\], \[\[Dave Bonsall\]\], \[\[Kylie Jones Mattock\]\]
...
[^10_deadwood-22]: \[\[Peter Lowe\]\], \[\[Kylie Jones Mattock\]\]

> This should be an explicit trade-off between fire risk and the ecological value of deadwood. The indicator should not discourage/be apathetic towards fire risk management options that also promote good quality deadwood[^10_deadwood-23]

[^10_deadwood-23]: \[\[Ewan McHenry\]\]
...
-   Favourable: \>80 m<sup>3</sup> ha<sup>-1</sup>

-   Intermediate: 20 - 80 m<sup>3</sup> ha<sup>-1</sup>

-   Unfavourable: \< 20 m<sup>3</sup> ha<sup>-1</sup>
