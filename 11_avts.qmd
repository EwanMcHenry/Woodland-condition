...
Extend plot to a 1 ha square (50m from centre in each direction) and count AVTs (up to a maximum).
...
-   Wood pasture/parkland:
    ...
    -   Good condition would require eight or more[^11_avts-6]

    -   More important here[^11_avts-7]

-   Young woodland - Expect none[^11_avts-8], lower importance[^11_avts-9]

-   Upland/montane[^11_avts-10],

-   Coppice[^11_avts-11]

-   Alder carr, wet willow woodland more dynamic woods - retention of trees to veteran is less important[^11_avts-12]

-   Upland birch: may be solely veteran[^11_avts-13], but also potentially very dynamic[^11_avts-14]

[^11_avts-6]: \[\[Chris Reid\]\], \[\[Liam Plummer\]\], \[\[Adam Thorogood\]\]

[^11_avts-7]: \[\[Liam Plummer\]\], \[\[Jim Smith-Wright\]\]

[^11_avts-8]: \[\[Chris Reid\]\], \[\[Dave Bonsall\]\], \[\[Kylie Jones Mattock\]\], \[\[Hannah Patterson\]\], \[\[Ian Moss\]\]

[^11_avts-9]: \[\[Liam Plummer\]\], \[\[Hannah Patterson\]\], \[\[Louise Hackett\]\]

[^11_avts-10]: \[\[Peter Lowe\]\]

[^11_avts-11]: \[\[Peter Lowe\]\], \[\[Dave Bonsall\]\]

[^11_avts-12]: \[\[Adam Thorogood\]\]

[^11_avts-13]: \[\[Peter Lowe\]\]

[^11_avts-14]: Adam Thorogood

### Lower priority exceptions

Some species more value than others[^11_avts-15]

[^11_avts-15]: \[\[Jim Smith-Wright\]\]

Lowland ancient woodland often have no AVTs[^11_avts-16]

[^11_avts-16]: \[\[Peter Lowe\]\]

> Should they be managed with AVTs more in mind?

### Concerns already covered by this or other indicators

Commercial plantations[^11_avts-17]

[^11_avts-17]: \[\[Kylie Jones Mattock\]\]

> Will score low for this indicator if no AVTs present

If whole wood is old there is no space for young trees[^11_avts-18]

[^11_avts-18]: \[\[Alasdair Firth\]\]

> Should be dealt with via tree age or distribution and regeneration. Have Added suggestion to note where AVTs are the majority of trees present[^11_avts-19]

[^11_avts-19]: \[\[Ewan McHenry\]\]
