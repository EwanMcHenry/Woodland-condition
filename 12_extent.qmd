...
Urban woods surrounded and unable to expand, these might be constantly stuck in "Poor" condition because of this indicator: suggested lower importance here[^12_extent-11]

[^12_extent-11]: Hannah Patterson

> They need to be able to attain good condition based on other indicators.

Small woods within high-quality open habitat mosaic or upland peat[^12_extent-12]

[^12_extent-12]: Kylie Jones Mattock, David Logan
...
Higher importance where woodland has been lost in the landscape in recent years[^12_extent-13]

[^12_extent-13]: Rhiannon Hoy

### Lower priority exceptions

Farmland woods, hedges and edges[^12_extent-14]

[^12_extent-14]: Kylie Jones Mattock

> These would just score poorly for this particular indicator[^12_extent-15]

[^12_extent-15]: Ewan McHenry

Large monocultures e.g. Sitka plantations[^12_extent-16]

[^12_extent-16]: Hannah Patterson
...
Small woods can be important temporal refugia for species that are out competed in more connected woodland[^12_extent-17]

[^12_extent-17]: Ewan McHenry, Jim Smith-Wright

> Q: When does a wood becomes so small that it wouldn't be reasonable to see all indicators well represented? - Or when it could be a component of indicators in a landscape?[^12_extent-18]

[^12_extent-18]: Saul Herbert
