...
Good to have temporal continuity, but also spatial patchiness[^13_regen-5]

[^13_regen-5]: Saul Herbert

Recruitment from larger seedlings to saplings is most important, only happens when light above species-specific threshold[^13_regen-6]

[^13_regen-6]: Peter Lowe

Would planted trees count as regenerating age class?[^13_regen-7]

[^13_regen-7]: Saul Herbert

### Priority exceptions

Seasonality will have a big impact, early spring many class 1, then lost to browsing[^13_regen-8]

[^13_regen-8]: Jim Smith-Wright

Woodland type

-   Wood pasture: Less regeneration expected/desired, depending on grazing pulses etc[^13_regen-9]. Protection may be required to ensure regen[^13_regen-10]

-   Rainforest and other areas with important lower plant assemblages[^13_regen-11]

    > more emphasises needed to identify when there is "too much"

-   Woodland creation sites[^13_regen-12]: There may be no seed sources[^13_regen-13], lower importance when planting, greater importance when relying on natural colonisation[^13_regen-14],

    -   More variable growth rates [^13_regen-15]

[^13_regen-9]: Chris Reid, David Venables

[^13_regen-10]: David Logan

[^13_regen-11]: Kylie Jones Mattock, Adam Thorogood

[^13_regen-12]: Dean Kirkland

[^13_regen-13]: Ian Moss

[^13_regen-14]: Ewan McHenry

[^13_regen-15]: David Logan

Spatial scale: Regen it important at site, but not necessarily at plot-scale[^13_regen-16]. Its OK to have no regen in an individual plot, as long as it is elsewhere

[^13_regen-16]: Dave Bonsall

Species that is regenerating[^13_regen-17]

[^13_regen-17]: Daniel Aitken

Closed canopy[^13_regen-18]
...
-   Can be ephemeral because of grazing (slugs, deer etc)[^13_regen-21]:
    ...
    -   Presence in e.g. A spring survey, doesn't guarantee survival in 2 months
