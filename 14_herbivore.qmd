...
-   Focus on canopy gaps, edge etc, within or close to plot (more potential for saplings), avoid herbivore-inaccessible parts (e.g. Cliff edges).
...
![](images/Herbivore%20Imapct%202023-11-14%2015.44.46.excalidraw.png){width="600"}
