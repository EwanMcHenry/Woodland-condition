...
![](images/Tree health 2023-11-14 16.12.01.excalidraw.png)
...
Low amounts could break up a single-species stand to increase structural complexity[^15_tree-heath-4], deadwood accumulation[^15_tree-heath-5] and nutrient cycling[^15_tree-heath-6]

[^15_tree-heath-4]: \[\[Dave Bonsall\]\]

[^15_tree-heath-5]: \[\[Kylie Jones Mattock\]\]

[^15_tree-heath-6]: \[\[Jim Smith-Wright\]\]

> This may be best dealt with via indicators that directly capture those aspects.

Potential conflict with deadwood, which may be generated via pests and disease[^15_tree-heath-7]. Tree mortality may be particuarlly important where deadwood is scarce[^15_tree-heath-8]

[^15_tree-heath-7]: \[\[Richard Brown\]\]

[^15_tree-heath-8]: \[\[Kylie Jones Mattock\]\]

> This should really be dealt with independently using the deadwood indicator.
