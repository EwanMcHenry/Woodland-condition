...
The presence of an appropraite and rich community of ground flora species is a biodiverisity indicator.
...
See considerations and challenges in [Native Tree and Shrub Species](08_native_tree_spceis_richness.qmd)[Richness](08_native_tree_spceis_richness.qmd#Challenges)[(N)](08_native_tree_spceis_richness.qmd).
...
Should licehns/bryophyes count towards this in e.g. rainforest zone? Oceanic mosses etc - Important for rainforest, but require more training to identify etc - Lower and non-vascular plants
...
Expected species vary widely by woodland type/region/geology/topographic heterogeneity etc. Condition should relate to the expectation for the site, were it in good condition[^16_ground-flora-2], or introduce bias between site types/geography.

[^16_ground-flora-2]: \[\[Louise Hackett\]\]
...
-   Woodland creation sites[^16_ground-flora-10] -

-   Closed canopy[^16_ground-flora-11] -

-   Woodland with high-shading tree spcecies (e.g. hornbeam, beech)[^16_ground-flora-12]
...
[^16_ground-flora-9]: \[\[Liam Plummer\]\]

[^16_ground-flora-10]: \[\[Dave Bonsall\]\], \[\[Kylie Jones Mattock\]\], \[\[Hannah Patterson\]\]

[^16_ground-flora-11]: \[\[Dave Bonsall\]\]

[^16_ground-flora-12]: \[\[Dave Bonsall\]\]

Different species may have different value, which may vary by habitat type[^16_ground-flora-13].

[^16_ground-flora-13]: \[\[Alasdair Firth\]\], \[\[Louise Hackett\]\]

-   e.g. ancient woodland plants weight more important, common plants like vaccinium still indicative, but lower score

Woodland Extent interaction: bigger woods expected to have more species expected per unit area[^16_ground-flora-14], although this could be said for most of the indicators (as they indicate better structure, capable of hosting more ground flora species)[^16_ground-flora-15].

[^16_ground-flora-14]: \[\[Jim Smith-Wright\]\]

[^16_ground-flora-15]: Ewan McHenry
...
Ancient vs secondary woodland and seedbank/soil condition differences[^16_ground-flora-16]

[^16_ground-flora-16]: \[\[Dave Bonsall\]\]

> Here sites with reduced seedbank may just score poorly, potentially leading to management considerations RE translocations.

Commercial forestry[^16_ground-flora-17]

[^16_ground-flora-17]: \[\[Kylie Jones Mattock\]\]

> Will just score poorly, prompting explicit trade-off between ecological condition and commercial productivity.

Air and soil quality[^16_ground-flora-18]

[^16_ground-flora-18]: \[\[Ian Moss\]\]
