...
make_domin_lookup <- function(value_data, summary_func = median) {
  ...
  domin_ranges <- list(
    "0"                  = function(x) x == 0,
    "1: <4% few"         = function(x) x < 4,
    "2: <4% several"     = function(x) x < 4,
    "3: <4% many"        = function(x) x < 4,
    "4: 4-10%"           = function(x) x >= 4 & x < 10,
    "5: 10-25%"          = function(x) x >= 10 & x < 25,
    "6: 25-33%"          = function(x) x >= 25 & x < 33,
    "7: 33-50%"          = function(x) x >= 33 & x < 50,
    "8: 50-75%"          = function(x) x >= 50 & x < 75,
    "9: 75-90%"          = function(x) x >= 75 & x < 90,
    "10: 90-100%"        = function(x) x >= 90
  )
