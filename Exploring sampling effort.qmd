...
-   A plot of the **sizes of the quantile ranges**[^exploring-sampling-effort-1], focusing more explicitly on how the amount of uncertainty varies with different sample sizes at different zones and on average (predicted using a GAM).
...
[^exploring-sampling-effort-1]: **e.g. a 50% quantile range is the range of the most-central 50% of simulated results.**
