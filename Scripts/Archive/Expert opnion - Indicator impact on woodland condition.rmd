...
Expert opinion on the value function and weight for each indicator was elicited using the Delphi method. The Delphi method is designed to collect and distill expert knowledge, using repeated surveys to refine estimates, increasing their reliability <!-- (Edwards et al., 2011) --> and identifying where agreements and disagreements in understanding occur.\
...
Indicators of Woodland Ecological Condition - Show/Hide
...
<button class="btn btn-primary" data-toggle="collapse" data-target="#Scaling_info">

Details of responses requiring scaling - Show/Hide

</button>

::: {#Scaling_info .collapse}
...
<button class="btn btn-primary" data-toggle="collapse" data-target="#completion_summary">

Survey completion summary - Show/Hide

</button>

::: {#completion_summary .collapse}
...
<button class="btn btn-primary" data-toggle="collapse" data-target="#completion_details">

Survey completion details - Show/Hide

</button>

::: {#completion_details .collapse}
...
categorised_vf_fig(filtered_data,
                   ind.num = ind.num,
                   indicator_name = indicator_name,
                   ind.axis.title = ind.axis.title
                   )
...
continuous_vf_fig(filtered_data)
```
...
VFs:\
- Feeling consensus may strengthen easily here - Particular focus useful for 1-2 species
...
Weights: - Massive variation, may need some evidence or guidance.
