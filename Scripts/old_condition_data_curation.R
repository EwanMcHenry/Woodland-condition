...
overall0$n_plots <- ifelse(is.na(overall0$n_plots), 0, overall0$n_plots)
...
curated_data_description_plots <- c(
  ...
  paste0(
    ...
    "- Covering ", 
    format(min(as.Date(long_plots0$ActualObservationDate, format = "%Y-%m-%d"), na.rm = TRUE), "%Y"),
    " to ",
    format(max(as.Date(long_plots0$ActualObservationDate, format = "%Y-%m-%d"), na.rm = TRUE), "%Y"),
    ".\n\n",
...
curated_data_description_overall <- c(
  ...
  paste0(
    ...
    "- Covering ", 
    format(min(as.Date(overall0$ActualObservationDate, format = "%Y-%m-%d"), na.rm = TRUE), "%Y"),
    " to ",
    format(max(as.Date(overall0$ActualObservationDate, format = "%Y-%m-%d"), na.rm = TRUE), "%Y"),
    ".\n\n",
