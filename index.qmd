...
```{r Select Delphi round, echo = F, include = F, eval = T }
delphi.round <- 1
...
2.  [Project background and scope](001_project%20background.qmd)

3.  [An explanation of the general approach to estimate condition](01_general%20approach.qmd)

4.  [The methods to gather and analyse evidence, particularly expert opinion](02_methods.qmd)

5.  Expert opinion Delphi Process - with estimated value functions and weightings

```         
1.  [Instructions to experts for round 2 of Delphi process](002_delphi_r2_instructions.qmd)

2.  A series of pages for each indicator in turn exploring:
...
3.  An exploration of the [importance weightings](04_Importance%20weightings.qmd) for each indicator
```

6.  [An exploration of data from the previous Woodland Condition Assessment on the Woodland Trust Estate](Exploring%20Old%20Condition%20Data.qmd)

    -   Includes attempts to build scores comparable with WECA

# Code map

Hopefully this figure helps understand how the different scripts work together... for those with a geeky interest. I made it mainly for me to keep track of things.

![](images/Condition%20code%20structure%202024-11-11%2016.43.03.excalidraw.png)
