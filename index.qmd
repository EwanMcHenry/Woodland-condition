...
Hi, a lot of the figures in this book are interactive. You can hover to get more info, and for some you can filter out different data etc. The book explores `r has_completed$indicator_name %>% unique() %>% length()` indicators of woodland ecological condition: their effective measurement and how those measurements might be used to assess the ecological condition of a woodland site, based upon evidence from the literature and the expert opinion, gathered from Woodland Trust staff.
...
3.  [The methods to gather and analyse evidence, particularly expert opinion](02_methods.qmd)
...
5.  A series of pages for each indicator in turn exploring:
    1.  Justification of its inclusion
    2.  A proposed measurement method
    3.  An exploration of value functions and weightings
    4.  Further considerations for indicator development
    5.  Exceptions where a general approach may require adaptation.
    ...
    6.  Approaches to this indicator from other organisations
